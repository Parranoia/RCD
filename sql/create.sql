...
INSERT INTO `pages` (`id`, `position`, `name`, `content`, `custom`) VALUES
    ...
    (4, 3, 'articles', '<h1>Articles</h1>\n<h3>2014</h3>\n<ul>\n<li><a href="../assets/docs/pressrelease.pdf" target="_blank">Press Release</a></li>\n</ul>\n<h3>2013</h3>\n<ul>\n<li><a href="http://blogs.roanoke.com/theburgs/news/2013/10/12/new-child-care-center-to-open-in-radford/" target="_blank">Roanoke Times - New Child Care</a></li>\n<li><a href="http://www.southwesttimes.com/2013/08/radford-child-development-inc-bringing-accredited-child-care-to-nrv/" target="_blank">Southwest Times - Accredited Child Care</a></li>\n<li><a href="http://www.southwesttimes.com/2013/10/rcd-inc-receives-funds-and-location-for-child-care-facility/" target="_blank">Southwest Times - Recieves Funding</a></li>\n<li><a href="http://wsls.membercenter.worldnow.com/story/23661590/radford-child-development-in-gets-money-location-for-facility" target="_blank">WSLS10 - Facility Location</a></li>\n<li><a href="http://www.radford.edu/content/radfordcore/home/news/releases/2013/October/new-RU-child-care-facility.html" target="_blank">Radford University - Location Set</a></li>\n</ul>', 0),
    (5, 2, 'about', '<h1 style="text-align: center;">Future Location</h1>\n<p><iframe style="border: 0;" src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d2110.458933924279!2d-80.535697!3d37.12364!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sen!2sus!4v1395614104168" width="400" height="300" frameborder="0"></iframe></p>\n<h3>Who are we?</h3>\n<p>Radford Child Development, Inc. (RCD) is a grassroots, community-led, non-profit organization established in 2012 to develop a quality, certified child care facility in Radford. It is run by a diverse board of directors who devote their time, expertise, and personal funds to support an organizational mission that is critical to the Radford community. Based on an extensive needs assessment conducted last year, at least 9 out of 10 children in the City of Radford do not have access to state-licensed child care. Working parents are struggling to find child care that even meets minimum state licensing standards. There is no option for quality certified child care in the community. Lack of access to child development facilities has a long-lasting negative impact on our community. According to research, providing quality early childhood education is an effective strategy for moving people out of poverty. Bringing a quality, education-based facility to Radford is a long term investment that will:</p>\n<ol>\n<li>Enable Radford families to have access to the essential educational foundation of quality childcare</li>\n<li>Provide necessary community facilities and infrastructure for working parents in order to improve their own lives and make contributions to our community</li>\n<li>Bring fundamental and lasting change to the entire Radford community and our low-wealth community members. It also strengthens the community by supporting economic growth and making our area more attractive for new businesses and housing</li>\n</ol>\n<p>Our Mission is to develop and/or support excellent, nationally accredited child development program(s) in Radford that embodies the best practices of early childhood care and education. One of our fundamental goals is to make this accessible to all income levels in our community. We believe that providing low-wealth families with access to a high level educational environment for their children will not only improve kid&rsquo;s chances to succeed academically and move out of poverty, but will also have an immediate impact on the family finances by providing parents with time to work, knowing that children are in a safe and stimulating environment.</p>\n<h3>Major Strategies</h3>\n<p>RCD is a non-profit organization that was established by members of the Radford community to address an immediate and essential need for all Radford community members. We understand that all working parents need to have access to a quality certified educational child development facility. Our major strategies include:</p>\n<ol>\n<li>Attracting a quality nationally certified child care provider to Radford, VA</li>\n<li>Providing external funds for pre-opening expenses to make operating a center financially feasible</li>\n<li>Providing tuition discounts to low-wealth families</li>\n<li>Creating awareness, disseminating information, and involving all community members</li>\n<li>Recruiting and retaining highly qualified teachers</li>\n<li>Working with United States and Commonwealth representatives to change local/state/federal policies related to child development facilities</li>\n</ol>\n<h3>Benefits of a Radford Child Development Center</h3>\n<ul>\n<li>A Radford resource available to all Radford area employers.</li>\n<li>Internship opportunities for RU early education and other disciplines.</li>\n<li>Highest quality NAEY-C childcare in Radford to serve our communities\'s children and families.</li>\n</ul>\n<h3>We are 501c3 pending</h3>\n<p>Although the 501c3 application process can take several months, we anticipate IRS approval for this nonprofit.</p>\n<h3>What does this mean?</h3>\n<p>Radford Child Development, Inc. is a non-profit organization incorporated in the state of Virginia. Nonprofit organizations are given 27 months from the date of incorporation to fill out IRS form 1023 to apply for tax-exempt status. We completed and submitted our 1023 form to IRS.</p>\n<h3>Why does this matter to you?</h3>\n<p>Once 1023 approved, it is inclusive of all donations taken in from the incorporation date to the date of 501c3 approval. Basically, this means that your donations are tax-deductible.</p>\n<h3>Strategic Partners</h3>\n<ol>\n<li>Community Foundation of New River Valley</li>\n<li>Radford University Foundation</li>\n<li>Price Williams Realtors</li>\n<li>Radford City</li>\n<li>Radford Public Schools</li>\n<li>DIVAS</li>\n<li>Rainbow Riders</li>\n<li>Smart Beginnings</li>\n</ol>\n<h3>Contact Us</h3>\n<p>Email: <a href="mailto:radfordchilddevelopment@gmail.com">radfordchilddevelopment@gmail.com</a><br /> Phone: (434) 227-7196</p>\n<h3>Keep in mind...</h3>\n<p>No goods or services will be provided in exchange for your donation. Your donation is tax deductible to the extent allowed by law.</p>', 0);
