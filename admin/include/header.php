        ...
        <div class="wrapper">
            <div class="nav">
            	<ul>
                    ...
                    <?php if ($_SESSION['user']['privilege'] === 2) print('<li><a href="#"><i class="fa fa-users fa-fw"></i> Manage Users</a></li>'); ?>
                    <li><a href="#"><i class="fa fa-list fa-fw"></i> View Interested List</a></li>
